...
function highlightValidMoves(piece, index) {
    validMoves = [];
    validMoves = calculateValidMoves(gameState, piece, index); // Implement this function based on the rules for each piece
...
function handleCellClick(event) {
    ...
    console.log("White King pos ", gameState.whiteKingPos)
    console.log("Black King pos ", gameState.blackKingPos)
